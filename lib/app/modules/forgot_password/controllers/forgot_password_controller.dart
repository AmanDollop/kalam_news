  ...
  Future<void> callingSendOtpApi() async {
    try{
      ...
      if(res != null && res.statusCode == 200){
        ...
        print('responseMap[ApiConstantVar.otp]::::  ${responseMap[ApiConstantVar.otp]}');
        Get.toNamed(Routes.OTP,arguments: ['Forgot Password',emailAndMobileNumberController.text.trim().toString(),'${responseMap[ApiConstantVar.otp]}']);
