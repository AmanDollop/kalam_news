...
class GenealogyController extends GetxController {
  ...
  Future<void> onInit() async {
    ...
    bodyParamsForGetUserTreeApi = {ApiConstantVar.userId: ''};
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  KNPWidgets.commonDividerView(wight: 1.px),
                  SizedBox(height: 4.px),
                  commonRowForDialog(text1: PageConstVar.mobile.tr, text2: '${userDetailsForUserTree?.mobileNumber}'),
                  SizedBox(height: 4.px),
                  KNPWidgets.commonDividerView(wight: 1.px),
                  if (userDetailsForUserTree?.dob != null && userDetailsForUserTree!.dob!.isNotEmpty)
                    SizedBox(height: 4.px),
                  if (userDetailsForUserTree?.dob != null && userDetailsForUserTree!.dob!.isNotEmpty)
                    commonRowForDialog(text1: PageConstVar.dob.tr, text2: CMForDateTime.dateFormatForDateMonthYear(date: '${userDetailsForUserTree?.dob}')),
                ],
              ),
            ),
          );
