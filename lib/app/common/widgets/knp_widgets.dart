  ...
  static Widget commonOtpView(
    ...
    return PinCodeTextField(
      ...
      pinTheme: PinTheme(
        ...
        inactiveColor: inactiveColor ?? Theme.of(Get.context!).colorScheme.surface,
        inactiveFillColor: inactiveFillColor ?? Theme.of(Get.context!).colorScheme.surface,
        selectedColor: selectedColor ?? Theme.of(Get.context!).colorScheme.primary,
        selectedFillColor: selectedFillColor ?? Theme.of(Get.context!).colorScheme.primary.withOpacity(.1),
        activeColor: activeColor ?? Theme.of(Get.context!).colorScheme.primary,
        activeFillColor: activeFillColor ?? Theme.of(Get.context!).colorScheme.primary.withOpacity(.1),
        shape: shape,
      ...
      enableActiveFill: shape == PinCodeFieldShape.box || shape == PinCodeFieldShape.circle
              ? true
              : false,
      controller: controller,
      onChanged: onChanged,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
          ).paddingOnly(top: CommonPaddingAndSize.size20(), bottom: CommonPaddingAndSize.size10()),
          Text(
      ...
      child: isLoading
          ? Center(
              child: SizedBox(
                ...
                child: commonProgressBarView(color: Theme.of(Get.context!).colorScheme.inversePrimary),
              ),
            )
          : child ?? Text(
                buttonText ?? '',
...
/* --------------------------Radio Button View--------------------------*/
  ...
  static String extractTextFromHtml({required String htmlString}) {
